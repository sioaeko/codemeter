...
echo "and connect to the CYD Usage Meter over Bluetooth Low Energy."
echo ""
echo "First-time Bluetooth pairing:"
echo "  1. Power on the CYD Usage Meter"
echo "  2. Run: bluetoothctl scan le"
echo "  3. Find 'CYD Usage Meter' and note the MAC address"
